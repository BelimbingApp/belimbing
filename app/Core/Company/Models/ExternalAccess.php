...
use App\Core\Company\Models\Concerns\BuildsCompanyAuditEntries;
use App\Core\Company\Models\Concerns\ResolvesRelationshipCompanies;
...
class ExternalAccess extends Model
{
    ...
    use ResolvesRelationshipCompanies;
