...
class EditFileTool extends AbstractTool
{
    ...
    public function parametersSchema(): array
    {
        return [
            ...
            'properties' => [
                ...
                'target_surface' => [
                    'type' => 'string',
                    'description' => 'Repository ownership surface: "platform", "domain:<slug>", or "extension:<slug>". Defaults to "platform".',
                ],
            ],
            'required' => ['file_path'],
        ];
        ...
        return [
            ...
            'testExamples' => [
                [
                    ...
                    'input' => [
                        'file_path' => 'app/Core/Example/Models/Example.php',
                        'content' => "<?php\n\nnamespace App\\Core\\Example\\Models;\n\nuse Illuminate\\Database\\Eloquent\\Model;\n\nclass Example extends Model\n{\n}\n",
                        'operation' => 'write',
                    ],
                    'runnable' => false,
                ],
            ...
            'limits' => [
                ...
                'Edit result diff_preview is capped at '.self::MAX_DIFF_PREVIEW_BYTES.' bytes',
            ],
        ];
    }
    ...
    protected function handle(array $arguments): ToolResult
    {
        ...
        $targetSurface = $this->optionalString($arguments, 'target_surface') ?? 'platform';
