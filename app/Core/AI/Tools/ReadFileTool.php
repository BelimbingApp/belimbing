...
class ReadFileTool extends AbstractTool
{
    ...
    protected function schema(): ToolSchemaBuilder
    {
        return ToolSchemaBuilder::make()
            ...
            ->string('target_surface', 'Repository ownership surface: "platform", "domain:<slug>", or "extension:<slug>". Defaults to "platform".')
    ...
    protected function toolMetadata(): array
    {
        return [
            ...
            'explanation' => 'Reads files from the BLB platform, a domain, or an extension surface with repository-root path checks. '
