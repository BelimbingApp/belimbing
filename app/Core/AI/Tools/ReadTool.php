...
use App\Core\AI\Tools\Concerns\BuildsSurfaceToolPayload;
...
class ReadTool extends AbstractTool implements ProvidesDisplaySummary
{
    ...
    protected function toolMetadata(): array
    {
        return [
            ...
            'explanation' => 'Reads files from BLB platform, domain, or extension surfaces and executes guarded read-only SQL queries. '
