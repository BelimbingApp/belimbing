...
| of work everywhere else, never failing a production request.
...
return [
    'enabled' => (bool) env('HYDRATION_GUARD_ENABLED', true),

    // Models hydrated per unit of work before the guard reacts.
    'limit' => (int) env('HYDRATION_GUARD_LIMIT', 5000),

    // "throw" or "log". Unset: throw in local and testing, log elsewhere.
    'mode' => env('HYDRATION_GUARD_MODE'),
];
