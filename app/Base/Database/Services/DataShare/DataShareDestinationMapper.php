...
class DataShareDestinationMapper
{
     ...
     */
    public function classify(DataShareTableDefinition $table, array $record): array
    {
    ...
    /** @param array<string, mixed> $record */
    public function desiredValues(DataShareTableDefinition $table, array $record): array
    {
        $desired = [];
    ...
    public function remember(DataShareTableDefinition $table, array $row): void
    {
    ...
    /** @param array<string, mixed> $row */
    public function rowFingerprint(DataShareTableDefinition $table, array $row): string
    {
        $normalized = [];
    ...
    private function referencesResolvable(DataShareTableDefinition $table, array $desired): bool
    {
        foreach ($table->references as $reference) {
    ...
    private function rowMatches(DataShareTableDefinition $table, array $row, array $incoming): bool
    {
    ...
    /** @param array<string, mixed> $desired */
    private function hasUniqueCollision(DataShareTableDefinition $table, array $desired): bool
    {
