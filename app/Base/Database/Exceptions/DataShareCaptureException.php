...
class DataShareCaptureException extends RuntimeException
{
    ...
    {
        return new self(__('Data Share disk :disk is public. Configure a private filesystem disk before capturing rows.', ['disk' => $disk]));
    }
