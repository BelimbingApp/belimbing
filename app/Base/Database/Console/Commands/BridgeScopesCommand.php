...
#[AsCommand(name: 'blb:db:bridge:scopes')]
class BridgeScopesCommand extends Command
{
    protected $signature = 'blb:db:bridge:scopes {--json : Emit machine-readable JSON}';

    protected $description = 'List Base-discovered module and table export scopes';

    public function handle(BridgeScopeCatalog $catalog): int
    {
