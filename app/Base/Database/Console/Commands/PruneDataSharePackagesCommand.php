...
#[AsCommand(name: 'blb:db:share:prune')]
class PruneDataSharePackagesCommand extends Command
{
    protected $signature = 'blb:db:share:prune
    ...
    protected $description = 'Preview or apply conservative Data Share package retention';

    public function handle(DataSharePackageRetention $retention): int
    {
