...
{
    private const SECRET_INPUT_MASK = '******';
    ...
    private function secretInputVariants(): array
    {
        return [
            [
                ...
                'savedMask' => self::SECRET_INPUT_MASK,
            ...
            [
                ...
                'code' => '<x-ui.secret-input :has-value="true" :show-reveal-button="false" saved-mask="'.self::SECRET_INPUT_MASK.'" help="Focus to replace. Saving without changes keeps the current value." />',
                'label' => 'Parser token',
                'value' => self::SECRET_INPUT_MASK,
                'hasValue' => true,
