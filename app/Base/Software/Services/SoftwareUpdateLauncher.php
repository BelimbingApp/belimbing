...
final class SoftwareUpdateLauncher
{
    ...
    /** Recover the reservation owned by an exact abandoned update run. */
    public function releaseStaleUpdateLock(string $runId): void
    {
        Cache::restoreLock(self::LOCK_KEY, $runId)->release();
    }
