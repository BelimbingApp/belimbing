...
/**
 * Shows each software source's current vs latest commit and lets the operator update
 * per source (or all) and gracefully reload — the in-app counterpart to the host
