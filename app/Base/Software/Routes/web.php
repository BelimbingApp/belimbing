...
Route::middleware(['auth'])->group(function () {
    Route::get('admin/system/software/deployment', DeploymentIndex::class)
        ->middleware('authz:admin.system.software.deployment.manage')
        ->name('admin.system.software.deployment.index');
