...
class DeploymentService
{
    public function __construct(
        private readonly DeploymentRunHistory $runHistory,
    ...
    private function runComposerInstall(): string
    {
        ...
        $this->runHistory->rememberComposerRun(! $this->hasError([$message]), $message);
    ...
    private function runFrontendBuild(?callable $progress = null): array
    {
        ...
        $this->runHistory->rememberFrontendRun(
            ! $this->hasError($log),
    ...
    public function reload(): array
    {
        ...
        $this->runHistory->rememberReload($webReloaded, $reloadMessage, $adminUrl);
    ...
    {
        return $this->adminEndpointFromEnvironment()
            ?? $this->adminEndpointFromOctaneState()
            ?? ['127.0.0.1', '2019'];
    }
     ...
     */
    private function adminEndpointFromEnvironment(): ?array
    {
     ...
     * @return array{0: string, 1: string}|null
     */
    private function adminEndpointFromOctaneState(): ?array
    {
