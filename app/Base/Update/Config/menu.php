...
return [
    'items' => [
        $item('admin.system.update.deployment', 'Deployment', 'heroicon-o-arrow-path', parent: 'admin.system.update', route: 'admin.system.update.deployment.index', permission: 'admin.system.update.deployment.manage'),
