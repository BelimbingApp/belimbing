 ...
 * The (turn_id, seq) pair provides strict ordering for SSE replay and resume.
 *
 * The event_type column stores the string backing value of TurnEventType,
 * which is the durable contract key shared across DB, SSE, and UI layers.
 *
...
class ChatTurnEvent extends Model
{
    ...
    /**
     * Format this event as an SSE-compatible array.
     *
