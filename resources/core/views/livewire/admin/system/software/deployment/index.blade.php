    ...
    >
        ...
        @if ($checkFailures !== [])
            <x-ui.alert variant="warning">
                {{ __('Could not check latest commits for these software sources: :sources. Public GitHub repositories do not need a token; see the Remote column for the Git response. If one of these repositories is private, add its owner token in', ['sources' => implode(', ', $checkFailures)]) }}
