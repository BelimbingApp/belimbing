<div>
    ...
    <div class="space-y-section-gap">
        ...
        <x-ui.card>
            <x-ui.table container="flush" :caption="__('Department types')" :row-hover="false">
                <x-slot name="head">
                <tr>
                    <x-ui.sortable-th
                        column="code"
                    ...
                    <tr wire:key="type-{{ $type->id }}" class="hover:bg-surface-subtle/50 transition-colors">
                        ...
                        >
                            ...
                            <input
                                ...
                                x-ref="input"
                                x-model="val"
                                aria-label="{{ __('Department type name') }}"
                        ...
                        >
                            ...
                            <select
                                ...
                                x-ref="input"
                                x-model="val"
                                aria-label="{{ __('Department type category') }}"
                        ...
                        >
                            ...
                            <input
                                ...
                                x-ref="input"
                                x-model="val"
                                aria-label="{{ __('Department type description') }}"
