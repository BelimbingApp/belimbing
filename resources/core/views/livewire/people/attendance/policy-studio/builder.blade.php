...
use App\Modules\People\Attendance\Livewire\PolicyStudio\Builder;

/** @var Builder $this */
?>

<div>
    <x-slot name="title">{{ __('Policy Builder') }}</x-slot>

    <div class="space-y-section-gap">
        <x-ui.page-header :title="__('Policy Builder')" :subtitle="__('Start from a template, tune the policy, then validate it before supervisors use it in rosters.')">
            <x-slot name="help">
