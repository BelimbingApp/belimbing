...
<p class="flex flex-wrap items-baseline gap-x-1 gap-y-2 text-sm text-ink-soft" x-data="{ open: null }">
    ...
    <span class="relative inline-block" x-data="{ moreOpen: false }" @click.outside="moreOpen = false">
        ...
        <div x-show="moreOpen" x-cloak x-transition.origin.top.left class="absolute left-0 z-20 mt-2 grid w-80 gap-3 rounded-2xl border border-border-default bg-surface-card p-4 shadow-lg" role="region">
            <div>
