...
use App\Core\AI\DTO\WorkspaceFileEntry;
...
{
    $systemPromptPath = app_path('Core/AI/Resources/lara/system_prompt.md');

    return new WorkspaceManifest(
        employeeId: Employee::LARA_ID,
        workspacePath: '/tmp/workspace/'.Employee::LARA_ID,
        isSystemAgent: true,
        frameworkResourcePath: app_path('Core/AI/Resources/lara'),
        files: [
