...
describe('contextForCurrentUser', function (): void {
    ...
    it('includes symbolic repository context equivalent to launching a coding agent from the project root', function (): void {
        ...
        expect($context['repository'])->not->toHaveKey('project_root')
            ->and($context['repository']['default_surface'])->toBe('platform')
            ...
            ->and($context['repository']['surfaces']['platform']['root'])->toBe('.')
            ->and($context['repository']['surfaces']['domains']['root_pattern'])->toBe('app/Domains/<Domain>')
            ->and($context['repository']['surfaces']['extensions']['root_pattern'])->toBe('app/Extensions/<Extension>')
