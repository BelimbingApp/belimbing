...
use App\Core\AI\DTO\Orchestration\RoutingDecision;
...
function makeToolCallingRuntimeSettingsWithBashEnabled(): AiRuntimeSettings
{
...
function makeToolCallingBashTool(): BashTool
{
    return new BashTool(runtimeSettings: makeToolCallingRuntimeSettingsWithBashEnabled());
}
