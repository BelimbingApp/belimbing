...
| [Domain CI composition](../ci/domain-ci.md) | How Domain identity is derived, what the composed smoke asserts, and why there are no pins. | [#940](https://github.com/BelimbingApp/belimbing/issues/940) |
