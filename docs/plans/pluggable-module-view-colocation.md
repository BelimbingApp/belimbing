...
**Sources:** `docs/architecture/pluggable-modules.md`, `docs/architecture/module-system.md`, `docs/architecture/ui-layout.md`, user discussion on full-stack module colocation.
**Agents:** Amp/GPT-5
