...
| `AgenticRuntime` | `app/Modules/Core/AI/Services/Runtime/AgenticRuntime.php` | Agentic loop: LLM call → tool execution → feed results → repeat. Uses Core AI config resolution and records runs/wire context |
